...
- Local override: `EXPO_PUBLIC_API_URL=http://10.0.2.2:18080 maestro test ...` (emulator) vs `https://api.example.com` (staging)
...
- [ ] staging health: curl 4 endpoints 200, manual smoke on staging
